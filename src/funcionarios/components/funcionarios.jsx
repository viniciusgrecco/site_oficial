...
function Funcionarios() {
  ...
  const [nomeProduto, setNomeProduto] = useState('POWER PROTEIN BAR');
  const [precoProduto, setPrecoProduto] = useState('R$ 90');
  const [quantidade, setQuantidade] = useState(1823);
  const [vendas, setVendas] = useState(578);
  const [satisfacao, setSatisfacao] = useState(4.3);
